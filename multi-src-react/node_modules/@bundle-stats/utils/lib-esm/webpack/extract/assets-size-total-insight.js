...
const INFO_TEMPLATE = template('<%= metric %> — <%= displayValue %> (<%= displayDeltaPercentage %>).');
const METRIC_NAME = 'totalSizeByTypeALL';
export const extractAssetsSizeTotalInsight = (webpackStats, currentExtractedData, baselineBundleStats) => {
