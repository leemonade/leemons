    ...
    <>
      <div className="bg-secondary-content  edit-mode w-full h-screen overflow-auto grid">
        <div className="bg-primary-content w-full">
          ...
          <div
            className="page-description  pb-12 max-w-screen-xl w-full mx-auto px-6"
            dangerouslySetInnerHTML={{ __html: t('page_info') }}
          />
          <Select
        ...
        <div className="flex max-w-screen-xl w-full mx-auto px-6">
          ...
          <div className="flex-1 m2">
            <aside className="help-wizard">
              ...
              <h2 className="help-wizard_name">{t('from_template_info.title')}</h2>
              <p className="help-wizard_description">{t('from_template_info.description')}</p>
