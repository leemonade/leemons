...
import { Avatar, Button, FormControl, Checkbox } from 'leemons-ui';
import { BanIcon, ChevronDownIcon } from '@heroicons/react/solid';

export default function ListTable() {
  const [translate] = useTranslate({
    keysStartsWith: 'plugins.classroom.edit_level_page.table',
  });
  const t = tLoader('plugins.classroom.edit_level_page.table', translate);
      ...
      <table role="table" className="table table-list table-fixed">
        <thead>
          <tr role="row" className="">
            <th colspan="1" role="columnheader" className="th w-14" title={t('th_actions')}>
              <FormControl label={t('th_actions')} className="read-only-label">
                <Checkbox />
              </FormControl>
            </th>
            <th colspan="1" role="columnheader" className="th">
              <Button color="primary" className="block btn-link font-inter btn-xs">
                {t('th_name')}
            ...
            <th colspan="1" role="columnheader" className="th w-28">
              {t('th_birthday')}
            </th>
          </tr>
        </thead>
        <tbody role="rowgroup">
          <tr role="row" className="is-error">
            <td role="cell" className="td ">
              <BanIcon className="w-4 h-4 text-error stroke-current" />
            </td>
            <td role="cell" className="td">
          ...
          <tr role="row" className="">
            <td role="cell" className="td">
              <FormControl label={t('th_check')} className="read-only-label">
                <Checkbox />
              </FormControl>
            </td>
            <td role="cell" className="td">
