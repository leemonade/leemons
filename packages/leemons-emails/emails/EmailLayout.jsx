          ...
          <Container className="bg-[#F8F9FB] my-[24px] mx-auto p-[36px] w-[552px] max-w-full">
            <Container className="text-center">
              <Img
                ...
                className="mx-auto"
              />
              <span className="text-[20px] font-medium block mt-4">
                {title}
              </span>
            </Container>
            {children}
            <Container className="text-center">
              <Text className="text-[14px] mt-0 mb-2">
                {messages[locale].bodyEnd}
              </Text>
            </Container>
            ...
            <Section>
              <Row>
                <Column>
                  <Text className="text-[12px] mt-0 leading-4">
                    Powered by:
                  </Text>
                </Column>
              </Row>
            ...
            <Section>
              ...
              <span className="text-[12px] text-[#878D96]">
                &nbsp;&nbsp;|&nbsp;&nbsp;
              </span>
              <Link
