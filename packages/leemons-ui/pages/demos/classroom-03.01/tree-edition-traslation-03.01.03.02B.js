            ...
            <div className="bg-secondary-content  edit-mode w-full h-screen overflow-auto grid">
                ...
                <div className="flex max-w-screen-xl w-full mx-auto px-6">
                    ...
                    <div className="flex-1 my-2 mb-2 bg-primary-content py-6 pl-12 pr-6">
                        ...
                        <div>
                            <Button color="primary" link className="pr-1 btn-link" onClick={toggleDrawer}>Translations</Button>
                    ...
                    <section>
                        ...
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0)">
                                <path d="M5 8.75V5.75C5 5.35218 5.15804 4.97064 5.43934 4.68934C5.72064 4.40804 6.10218 4.25 6.5 4.25C6.89782 4.25 7.27936 4.40804 7.56066 4.68934C7.84196 4.97064 8 5.35218 8 5.75V8.75" stroke="#8E97A3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M5 7.25H8" stroke="#8E97A3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M17 11V12.5" stroke="#8E97A3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M14 12.5H20" stroke="#8E97A3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M18.5 12.5C18.5 12.5 17 17 14 17" stroke="#8E97A3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M17 15.2666C17.3345 15.7654 17.7788 16.1809 18.2988 16.4813C18.8189 16.7817 19.4008 16.959 20 16.9996" stroke="#8E97A3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M11.75 19.25C11.3522 19.25 10.9706 19.092 10.6893 18.8107C10.408 18.5294 10.25 18.1478 10.25 17.75V10.25C10.25 9.85218 10.408 9.47064 10.6893 9.18934C10.9706 8.90804 11.3522 8.75 11.75 8.75H22.25C22.6478 8.75 23.0294 8.90804 23.3107 9.18934C23.592 9.47064 23.75 9.85218 23.75 10.25V17.75C23.75 18.1478 23.592 18.5294 23.3107 18.8107C23.0294 19.092 22.6478 19.25 22.25 19.25H20.75V23.75L16.25 19.25H11.75Z" stroke="#8E97A3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M7.25 13.25L4.25 16.25V11.75H2.75C2.35218 11.75 1.97064 11.592 1.68934 11.3107C1.40804 11.0294 1.25 10.6478 1.25 10.25V2.75C1.25 2.35218 1.40804 1.97064 1.68934 1.68934C1.97064 1.40804 2.35218 1.25 2.75 1.25H13.25C13.6478 1.25 14.0294 1.40804 14.3107 1.68934C14.592 1.97064 14.75 2.35218 14.75 2.75V5.75" stroke="#8E97A3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </g>
                            <defs>
                                <clipPath id="clip0">
                        ...
                        <Tabs>
                            <TabList>
                                ...
                                <Tab tabIndex='0'
                                    id='Tab2'
                                    panelId='Panel2'>
                                    French <ExclamationCircleIcon className={`w-3 h-3 ml-2 relative -top-1 text-error`} />
                                </Tab>
                            </TabList>
                            <TabPanel id='Panel1'>
