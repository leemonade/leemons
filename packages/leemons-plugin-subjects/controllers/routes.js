...
module.exports = [
  {
    ...
    authenticated: true,
    allowedPermissions: getPermissions(permissions.subject, ['view']),
  },
  {
    path: '/settings',
    method: 'POST',
    ...
    authenticated: true,
    allowedPermissions: getPermissions(permissions.subject, ['edit']),
  },
  {
...

  {
    ...
    handler: 'levels.add',
    authenticated: true,
    allowedPermissions: getPermissions(permissions.knowledge, ['create']),
  },
  {
    path: '/level/:id',
    method: 'GET',
    handler: 'levels.get',
    authenticated: true,
    allowedPermissions: getPermissions(permissions.knowledge, ['view']),
  },
  {
    path: '/level',
    method: 'GET',
  ...
  },
  {
    ...
    authenticated: true,
    allowedPermissions: getPermissions(permissions.knowledge, ['delete']),
  },
  {
    path: '/level/:id',
    method: 'PATCH',
    ...
    authenticated: true,
    allowedPermissions: getPermissions(permissions.knowledge, ['update']),
  },
  {
    path: '/level/:id/names',
    method: 'PATCH',
