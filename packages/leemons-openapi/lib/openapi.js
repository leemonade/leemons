...
function isAutoGeneratedFile(filePath) {
  ...
  return (
    (fileContent.includes("AIGenerated: 'true'") &&
      !fileContent.includes("//AIGenerated: 'true'") &&
      !fileContent.includes("// AIGenerated: 'true'")) ||
    (fileContent.includes('// summary:') && fileContent.includes('// description:')) // Esto ocurre cuando se ha autogenerado el archivo para añadir los openapi schemas de request y response
  );
}
