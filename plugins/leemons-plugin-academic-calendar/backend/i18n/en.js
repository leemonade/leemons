module.exports = {
  ...
  regionalList: {
    ...
    nameHolidayPlaceholder: 'Name of the holiday...',
    init: 'Init',
    end: 'End',
    add: 'Add',
    save: 'Save',
  ...
  programList: {
    ...
    selectCenter: 'Select center',
    emptyDescription:
      'No program has been created yet. To start with the calendars, please create the programs first.',
    emptyButton: 'Create program',
    basic: 'Basic data',
    periods: 'Events',
    preview: 'Preview',
    basicData: 'Basic data',
    regionalConfig: 'Regional configuration',
    coursesConfig: 'Courses configuration',
    completeCoursesTitle: 'Complete courses',
    ...
    substagesOrEvaluations: 'Substages or evaluations',
    init: 'Start',
    end: 'End',
