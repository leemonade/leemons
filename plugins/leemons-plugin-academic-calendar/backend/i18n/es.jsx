module.exports = {
  ...
  programList: {
    ...
    selectCenter: 'Seleccionar centro',
    emptyDescription:
      'No hay ningún programa creado. Para empezar con los calendarios, por favor crea primero los  programas',
    emptyButton: 'Crear programa',
    basic: 'Datos básicos',
    periods: 'Eventos',
    preview: 'Vista previa',
    basicData: 'Datos básicos',
    regionalConfig: 'Configuración regional',
    coursesConfig: 'Configuración de cursos',
    completeCoursesTitle: 'Cursos completos',
    ...
    substagesOrEvaluations: 'Subetapas o evaluaciones',
    init: 'Inicio',
    end: 'Final',
