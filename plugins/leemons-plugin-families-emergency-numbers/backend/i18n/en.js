module.exports = {
  config_page: {
    ...
    phone_modal: {
      ...
      message:
        "You are going to deactivate the emergency numbers add on, are you sure?",
  ...
  phone_numbers: {
    ...
    new_phone_number: "New Emergency Phone",
    update_phone_number: "Update Emergency Phone",
    name: "Name",
    phone: "Phone number",
    relation: "Relation",
    actions: "Actions",
    specify_relation: "Specify relation",
    save: "Save",
    edit: "Edit",
    delete: "Delete",
  },
