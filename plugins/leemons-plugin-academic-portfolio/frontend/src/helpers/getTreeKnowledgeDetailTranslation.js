export function getTreeKnowledgeDetailTranslation(t) {
  return {
    ...
    abbreviationLabel: t("knowledge.abbreviationLabel"),
    abbreviationHelper: t("knowledge.abbreviationHelper"),
    abbreviationRequired: t("knowledge.abbreviationRequired"),
    colorLabel: t("knowledge.colorLabel"),
    colorRequired: t("knowledge.colorRequired"),
    crCourse: t("knowledge.crCourse"),
