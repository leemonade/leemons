module.exports = {
    ...
    programDrawer: {
      ...
      wizardForm: {
        ...
        doesItHaveSequentialCourses:
          "¿Es necesario terminar un curso para comenzar el siguiente?",
        doesItHaveCycles: "¿Se agrupan esos cursos en ciclos educativos?",
        doesItHaveSubstages:
          "¿Hay subetapas de evaluación? (por ejemplo, trimestres o semestres)",
        doesItHaveKnowledgeAreas:
          "¿Existen áreas de conocimiento que agrupen asignaturas?",
        ...
        doesItHaveOfficialCredits:
          "¿Necesitas usar un sistema oficial de créditos? ",
      ...
      addProgramForm: {
        ...
        nomenclature: {
          ...
          success: {
            set: "Nomenclatura del programa actualizada correctamente.",
          },
        },
    ...
    setup: {
      ...
      basicData: {
        ...
        labels: {
          ...
          hideStudentsToStudents:
            "Ocultar el listado de usuarios al perfil de estudiante",
      ...
      coursesData: {
        ...
        labels: {
          ...
          hideCoursesInTree:
            "Ocultar cursos en el árbol (no anidar la asignaturas por curso)",
  ...
  newSubjectsPage: {
    ...
    emptyStates: {
      ...
      createProgram: "Crear programa",
      noSubjectsCreated:
        "No hay ningún asignatura creada. Por favor crea una asignatura",
    ...
    drawer: {
      ...
      classroomsSetup: {
        ...
        disableReferenceGroups:
          "Esta asignatura no pertenece a un Grupo de Referencia",
    ...
    deleteModal: {
      ...
      description:
        '¿Estás seguro de que quieres eliminar la asignatura "{subjectName}"? ',
      confirm: "Eliminar",
    },
    duplicateModal: {
  ...
  subject_page: {
    ...
    programTreeType: {
      ...
      opt3DescriptionCycle:
        "Programa > Ciclo > Curso > Tipo > Área de conocimiento > Asignatura",
      opt3DescriptionNoCourseCycle:
        "Programa > Ciclo > Tipo > Área de conocimiento > Asignatura",

      opt1Description:
        "Programa > Curso > Grupo > Tipo > Área de conocimiento > Asignatura",
      opt1DescriptionNoCourse:
        "Program > Grupo > Tipo > Área de conocimiento > Asignatura",
      opt2Label: "Clase + Área primero",
      opt2Description:
        "Programa > Curso > Grupo > Área de conocimiento > Tipo > Asignatura",
      opt2DescriptionNoCourse:
        "Program > Grupo > Área de conocimiento > Tipo > Asignatura",
      opt3Label: "Asignatura primero",
      opt3Description:
        "Programa > Curso > Tipo > Área de conocimiento > Asignatura",
      opt3DescriptionNoCourse:
        "Programa > Tipo > Área de conocimiento > Asignatura",
  ...
  profiles_page: {
    ...
    teacher: "profesor",
    teacherDescription:
      "Reponsable de impartir una asignatura en un programa o curso.",
  ...
  tree_page: {
    ...
    enrrollmentDrawer: {
      ...
      noStudentsFoundPlural:
        "No se han encontrado estudiantes con estas etiquetas.",
      noStudentsFoundSingular:
        "No se han encontrado estudiantes con esta etiqueta.",
    ...
    class: {
      ...
      associateTeachersLabel: "Profesores adjuntos",
      ...
      customPeriod: {
        ...
        label:
          "Tiene fechas distintas al periodo de académico o de la asignatura",
        startDate: "Fecha inicio",
        endDate: "Fecha fin",
        defineAcademicPeriod: "Definir periodo académico",
        info: {
          academicPeriod: "El periodo académico actual va desde el",
          parentPeriod: "El periodo de la asignatura va desde el",
          noParentPeriod: "El periodo de la asignatura no está definido",
          noAcademicPeriod: "El periodo académico actual no está definido.",
        },
      },
    },
    subject: {
      customPeriod: {
        ...
        info: {
          academicPeriod: "El periodo académico actual va desde el",
          noAcademicPeriod: "El periodo académico actual no está definido.",
          childrenDifferentPeriods:
            "Algunas clases de esta asignatura tienen periodos personalizados diferentes",
        },
