module.exports = {
    ...
    programDrawer: {
      ...
      wizardForm: {
        ...
        doesItHaveSequentialCourses:
          "Is it necessary to finish a course to start the next one?",
        doesItHaveCycles: "Are those courses grouped into educational cycles?",
        doesItHaveSubstages:
          "Are there evaluation substages? (for example, quarters or semesters)",
        doesItHaveKnowledgeAreas:
          "Are there knowledge areas that group subjects?",
        ...
        doesItHaveOfficialCredits:
          "Do you need to use an official credit system?",
    ...
    setup: {
      ...
      coursesData: {
        ...
        labels: {
          ...
          hideCoursesInTree:
            "Hidden courses in the tree (subjects not nested behind courses)",
  ...
  newSubjectsPage: {
    ...
    emptyStates: {
      ...
      createProgram: "Create program",
      noSubjectsCreated:
        "No subjects have been created. Please create a subject",
    ...
    labels: {
      ...
      add: "Add",
      cannotDeleteSubject:
        "Only subjects with no students or teachers enrolled can be deleted.",
    },
    drawer: {
      title: "New subject",
      ...
      classroomsSetup: {
        ...
        disableReferenceGroups:
          "This subject does not belong to a Reference Group",
  ...
  subject_page: {
    ...
    programTreeType: {
      ...
      opt1DescriptionCycle:
        "Program > Cycle > Course > Group > Type > Area > Subject",
      opt1DescriptionNoCourseCycle:
        "Program > Cycle > Group > Type > Area > Subject",
      opt2DescriptionCycle:
        "Program > Cycle > Course > Group > Area > Type > Subject",
      opt2DescriptionNoCourseCycle:
        "Program > Cycle > Group > Area > Type > Subject",
  ...
  profiles_page: {
    ...
    teacher: "Teacher",
    teacherDescription:
      "Responsible for teaching the subjects of a program/course",
  ...
  tree_page: {
    ...
    enrrollmentDrawer: {
      ...
      enrollmentSeatsError:
        "Enrollment error: No available seats in some classroom or group ",
      remove: "Remove",
      search: "Search",
    },
    studentsTable: {
    ...
    program: {
      ...
      visitProgramDescription:
        "For further configuration it is necessary to visit",
    ...
    class: {
      ...
      customPeriod: {
        title: "Class dates",
        label:
          "Uses different dates than the academic period or the subject period",
        startDate: "Start date",
        endDate: "End date",
        defineAcademicPeriod: "Define the academic period",
        info: {
          academicPeriod: "The current academic period goes from",
          parentPeriod: "The current subject period goes from",
          noParentPeriod: "The current subject period is not defined",
          noAcademicPeriod: "The current academic period is not defined.",
        },
      },
    },
    subject: {
      customPeriod: {
        ...
        info: {
          ...
          childrenDifferentPeriods:
            "Some classes of this subject have different custom periods",
        },
