module.exports = {
  ...
  user_data_page: {
    ...
    systemData: {
      ...
      description2:
        "Fields included in the Leemons system that you can configure",
      table: {
        name: "Name",
      ...
      tableItems: {
        ...
        password: {
          name: "Password",
          description:
            "8 characters, 1 number, 1 uppercase, 1 special character",
          type: "Password",
        },
        name: {
          name: "Name",
          description:
            "String, 26 regular characters (without special characters)",
          type: "String",
        },
        surname: {
          name: "Surname",
  ...
  detail_profile: {
    ...
    options_modal: {
      title: "Translation",
      description:
        "Add here the translations of the profile info to your system languages",
      accept: "Accept",
      cancel: "Cancel",
      profile_name: "Profile name",
  ...
  registerPassword: {
    ...
    tokenError:
      "The code to set the password has expired or is not valid, contact your center.",
  ...
  selectProfile: {
    ...
    change_easy:
      "You can always change your profile or center from your user account.",
    log_in: "Log in",
  ...
  importUsers: {
    ...
    fieldsWithErrors:
      "There are fields with errors, correct them before importing.",
