module.exports = {
  ...
  user_data_page: {
    ...
    systemData: {
      ...
      description2:
        "Campos incluidos en el sistema Leemons que se pueden configurar",
      table: {
        name: "Nombre",
      ...
      tableItems: {
        ...
        password: {
          name: "Contraseña",
          description:
            "8 caracteres, 1 número, 1 mayúscula, 1 carácter especial",
          type: "Password",
        },
        name: {
          name: "Nombre",
          description:
            "Cadena, 26 caracteres regulares (sin caracteres especiales)",
          type: "String",
        },
        surname: {
          name: "Apellido",
  ...
  detail_profile: {
    ...
    translations_warning:
      "Es necesario guardar el perfil para almacenar las traducciones",
    options_modal: {
      title: "Traducción",
      description:
  ...
  selectProfile: {
    ...
    change_easy:
      "Siempre podrás cambiar de perfil o centro desde tu cuenta de usuario.",
    log_in: "Entrar",
