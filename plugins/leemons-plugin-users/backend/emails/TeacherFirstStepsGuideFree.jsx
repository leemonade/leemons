...
const TeacherFirstStepsGuideFree = ({
  locale = "en",
  ...
  return (
    ...
    >
      ...
      <Container className="text-[14px] leading-5 text-center mt-8">
        ...
        />
        <Text className="text-[14px] leading-5">
          {messages[locale].step01Description02}
        </Text>
        <Img
          className="w-full"
        ...
        />
        <Text className="text-[14px] leading-5">
          {messages[locale].step01Description03}
        </Text>
        <Img
          className="w-full"
      ...
      <Container className="text-center text-[14px] leading-5 mt-8">
        ...
        />
        <Text className="text-[14px] leading-5">
          {messages[locale].step02Description03}
        </Text>
      </Container>
