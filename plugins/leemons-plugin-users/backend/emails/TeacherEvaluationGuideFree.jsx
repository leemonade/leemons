...
const messages = {
  en: {
    ...
    stepByStepHelp:
      "Leemons has many more tools and possibilities. To discover them all, visit:",
  ...
  return (
    ...
    >
      ...
      <Container className="bg-white text-center px-4 pb-4 rounded-lg">
        ...
        <Link
          href={loginUrl}
          className="text-[14px] leading-5 underline break-all"
        >
          {loginUrl}
        </Link>
      </Container>
      ...
      <Container className="text-center mt-6">
        <Text className="text-[20px] font-bold">
          {messages[locale].step02More}
        </Text>
        <Text className="text-[14px] leading-5">
          {messages[locale].step03More}
        </Text>
        <Section>
          <Row>
      ...
      <Container className="text-center mt-6">
        ...
        <Text className="text-[14px] leading-5">
          {messages[locale].stepByStepHelp}
        </Text>
        <Button
      ...
      <Container className="text-center mt-6">
        <Text className="text-[20px] font-bold">
          {messages[locale].supportText}
        </Text>
        <Text className="text-[14px] leading-5">
          {messages[locale].supportContactText}
        </Text>
        <Button
