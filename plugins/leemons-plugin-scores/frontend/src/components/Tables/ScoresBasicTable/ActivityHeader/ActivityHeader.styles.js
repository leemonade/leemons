  ...
  (
    ...
    return {
      root: {
        ...
        display: "flex",
        justifyContent:
          isExpandable && (hovered || isExpanded) ? "space-between" : "center",
        ...
        borderRightColor:
          (isFirst || isBetween) && theme.colors.interactive01v1,
        borderLeftColor: (isLast || isBetween) && theme.colors.interactive01v1,
        "&:hover": {
          backgroundColor:
            isManualActivity && globalTheme.background.color.primary.subtle,
          border:
            isManualActivity && `1px solid ${globalTheme.hover.default.color}`,
          [`& .${getRef("removeIcon")}`]: {
            visibility: "visible",
          },
        },
