      ...
      activities: {
        ...
        filters: {
          ...
          evaluationReport: {
            ...
            disabledTooltip: {
              invalidPeriod:
                "Evaluation reports are only enabled for academic calendar periods",
        ...
        scoresTable: {
          ...
          updatedSuccess:
            "Updated {{student}}'s score in {{activity}} to {{score}}",
          updatedError:
            "Error updating {{student}}'s score in {{activity}} to {{score}}",
        },
        periodSubmission: {
