module.exports = {
  ...
  notebook: {
    ...
    tabs: {
      activities: {
        ...
        unableToOpen:
          "Error abriendo actividad, la actividad no se ha podido encontrar",
        filters: {
          filterBy: {
            activity: "Actividad",
            student: "Estudiante",
        ...
        scoresTable: {
          ...
          updatedSuccess:
            "Actualizada la nota de {{student}} en {{activity}} a un {{score}}",
          updatedError:
            "Error actualizando la nota de {{student}} en {{activity}} a un {{score}}",
        },
        periodSubmission: {
  ...
  finalNotebook: {
    ...
    update: {
      success:
        "Nota actualizada para {{student}} en {{subject}} a un {{score}}",
  ...
  evaluationNotebook: {
    ...
    unableToOpen:
      "Error al abrir la actividad, la actividad no se ha podido encontrar",
  ...
  myScores: {
    ...
    emptyStates: {
      noFilters: {
        title: "Seleccionar curso y periodo",
        description:
          "Selecciona el curso y luego filtra por periodos de evaluación.",
      },
      noResults: {
        title: "Sin resultados",
        description: "No hemos encontrado resultados para tu búsqueda.",
  ...
  manualActivityDeletionModal: {
    ...
    description:
      "¿Estás seguro de que quieres eliminar esta actividad calificable?",
    cancel: "Cancelar",
    confirm: "Eliminar",
  },
  pickRetakeTable: {
