...
const questionStatusIcons = {
  ...
  [QUESTION_RESPONSE_STATUS.PARTIAL]:
    "/public/tests/responseDetail/partial.svg",
  [QUESTION_RESPONSE_STATUS.NOT_GRADED]:
    "/public/tests/responseDetail/not-graded.svg",
...
function ResponseStatusIcon({ status }) {
  ...
  return (
    <img
      src={src}
      alt={`${questionStatusAltTextPrefix[status]} response Icon`}
    />
  );
}
