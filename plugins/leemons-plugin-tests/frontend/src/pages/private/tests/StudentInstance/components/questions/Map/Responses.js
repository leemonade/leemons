...
export default function Responses(props) {
  ...
  const components = question.mapProperties.markers.list.map(
    (response, index) => {
      ...
      if (store.viewMode) {
        ...
        return (
          <Box key={index} className={styles.mapResponsesContent}>
            ...
            {clued ? (
              <Box
                className={cx(styles.mapViewContent, styles.mapViewContentClue)}
              >
              ...
              <Box
                className={cx(styles.mapViewContent, styles.mapViewContentDone)}
              >
              ...
              >
                <Box
                  className={cx(
                    styles.mapViewContent,
                    styles.mapViewContentError
                  )}
                >
                  {currentValue === "-"
                    ? t("selectResponse")
                    : question.mapProperties.markers.list[currentValue]
                        .response}
                  <Box className={styles.mapViewIcon}>
