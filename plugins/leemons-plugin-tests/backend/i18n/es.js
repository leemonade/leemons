...
module.exports = {
  ...
  questionsBanksDetail: {
    ...
    needExplanationAndResponse:
      "Todas las respuestas necesitan un texto y una explicación",
    ...
    hideOptionsHelp:
      "Las opciones ocultas se identifican con el icono {{icon}}",
    hasStemResourceLabel: "Imagen destacada",
    hasCoverLabel: "Imagen destacada",
    stemResourceLabel: "Incluir recurso multimedia",
    stemResourceDescription:
      "Puedes añadir elementos de imagen, audio o video. ",
    ...
    questionCategories: {
      ...
      addCategoriesSeperatedByComma:
        "Escribe las categorías separadas por comas y pulsa enter",
    ...
    giftImport: {
      ...
      invalidFileDescription:
        "El archivo no es un archivo GIFT válido o está vacío",
  ...
  testsEdit: {
    ...
    questionsDescription:
      "Selecciona las preguntas del banco para utilizar en este test",
  ...
  studentInstance: {
    ...
    informationStart:
      "Esta actividad estará disponible el día {date} a las {hour}",
    ...
    noBlankQuestions:
      "<strong>Preguntas en blanco:</strong> No puedes dejar preguntas en blanco",
    blankQuestions:
    ...
    finishForceTestModalTitle:
      "El tiempo establecido para completar este test ha finalizado.",
    ...
    questionLabels: {
      ...
      openResponse: {
        minLengthCharacters:
          "Escribe aqui tu respuesta de mínimo {number} caracteres",
        maxLengthCharacters:
          "Escribe aqui tu respuesta de máximo {number} caracteres",
        minAndMaxLengthCharacters:
          "Escribe aqui tu respuesta entre {min} y {max} caracteres",
      },
    },
  },
  testAssign: {
    ...
    useSettings:
      "Selecciona un preajuste guardado anteriormente o crea una configuración nueva",
    ...
    categoriesLabel: CATEGORIES,
    noRequiredQuestions:
      "Las preguntas filtradas son menores que las solicitadas",
    defaultRules: {
      alert: "IMPORTANTE:",
