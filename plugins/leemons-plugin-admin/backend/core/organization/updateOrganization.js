...
async function updateOrganization({ ctx, ...body }) {
  ...
  const promises = [
    ...
    ctx.tx.call("users.platform.setAppearanceMainColor", {
      value: body.mainColor,
    }),
    ctx.tx.call("users.platform.setAppearanceMenuMainColor", {
      value: body.menuMainColor,
    }),
    ctx.tx.call("users.platform.setAppearanceMenuDrawerColor", {
      value: body.menuDrawerColor,
    }),
    ...
    ctx.tx.call("users.platform.setEmailWidthLogo", {
      value: body.emailWidthLogo,
    }),
    ctx.tx.call("users.users.updateEmail", {
