...
async function importNonIndexableAssets(filePath, { users }) {
  const items = await itemsImport(filePath, 'non_indexable_assets', 30, true, true);
...
module.exports = importNonIndexableAssets;
