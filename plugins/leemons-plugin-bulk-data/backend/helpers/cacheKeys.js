...
const getCurrentPhaseKey = (ctx) =>
  getTemplateStatusCacheKey({ ctx, key: "currentPhase" });
const getLastPhaseOnErrorKey = (ctx) =>
  getTemplateStatusCacheKey({ ctx, key: "lastPhaseOnError" });
