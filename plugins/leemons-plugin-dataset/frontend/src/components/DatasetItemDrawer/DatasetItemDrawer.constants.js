...
export const DATASET_ITEM_DRAWER_DEFAULT_PROPS = {
  messages: {
    ...
    userProfileDescription:
      "Displays only users of the selected profile type(s)",
    ...
    localeHelpDescription:
      "Use this text to orient the user to the expected content.",
    localeMultioptionSelectPlaceholderLabel: "First option",
    translateOptionsHelpLabel:
    ...
    translateOptionsModalDescription:
      "Add here the translations of the options into English",
