...
const {
  conditionsInGradeScale,
} = require("../conditions/conditionsInGradeScale");
const {
  gradeTagsInGradeScale,
} = require("../grade-tags/gradeTagsInGradeScale");
...
async function canRemoveGradeScale({ id, ctx }) {
  ...
  const nConditionsInGradeScale = await conditionsInGradeScale({
    gradeScale: gradeScaleIds,
    ctx,
  });
  ...
  const nGradeTagsInGradeScale = await gradeTagsInGradeScale({
    gradeScale: gradeScaleIds,
    ctx,
  });
  ...
  const nGradesInGradeScale = await gradesInGradeScale({
    gradeScale: gradeScaleIds,
    ctx,
  });
