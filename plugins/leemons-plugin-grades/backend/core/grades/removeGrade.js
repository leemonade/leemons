...
const {
  removeGradeTagsByGrade,
} = require("../grade-tags/removeGradeTagsByGrade");
const {
  removeGradeScaleByGrade,
} = require("../grade-scales/removeGradeScaleByGrade");
...
async function removeGrade({ id, ctx }) {
  ...
  await ctx.tx.db.Grades.updateMany(
    { id: gradeIds },
