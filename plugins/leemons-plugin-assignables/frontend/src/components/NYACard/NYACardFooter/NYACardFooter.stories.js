...
import { NYACARD_FOOTER_DEFAULT_PROPS } from "./NYACardFooter.constants";

export default {
  title: "leemons/Library/LibraryCardFooter",
  parameters: {
    component: NYACardFooter,
    design: {
      type: "figma",
  ...
  argTypes: {
    ...
    fileType: {
      options: ["audio", "video", "image", "bookmark", "noicon"],
      control: "select",
    },
  },
};
