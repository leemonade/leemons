        ...
        if (group.type === "group") {
          return group.classes.map((klass) => ({
            ...
            students: intersection(
              klass.assignableStudents,
              group.assignableStudents
            ),
          }));
        }
            ...
            <RadioGroup
              ...
              data={
                data?.map((klass) => ({
                  ...klass,
                  checked:
                    !klass.disabled && field.value?.includes(klass.value),
                })) || []
              }
              ...
              <Controller
                ...
                render={({ field }) => (
                  <SelectUserAgent
                    ...
                    placeholder={
                      localizations?.excludeStudentsInput?.placeholder
                    }
                    maxSelectedValues={0}
      ...
      <Controller
        ...
        render={({ field }) => (
          <Checkbox
            {...field}
            checked={field.value}
            label={localizations?.autoAssignStudents}
          />
        )}
      />
    </Box>
