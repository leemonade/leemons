module.exports = {
  ...
  assignmentForm: {
    ...
    groups: {
      ...
      class: {
        ...
        notAllStudentsAssigned:
          "Some students won't be included in the activity",
  ...
  activity_dashboard: {
    ...
    archiveModal: {
      ...
      message2:
        "After archiving this activity, you can add the scores in the notebook.",
    ...
    closeModal: {
      ...
      message2:
        "Students will not be able to send new responses once the activity is closed.",
  ...
  activities_list: {
    ...
    nonEvaluable:
      "The selected activity is no evaluable and have already been finished",
  },
  ongoing: {
  ...
  need_your_attention: {
    ...
    links: {
      ...
      library:
        "https://www.leemons.io/academy-post/the-amazing-leemons-library",
    },
    assigment: {
      subject: "Subject",
    ...
    welcome: {
      ...
      teacher: {
        ...
        description2:
          "Meanwhile, to get started, we recommend the following actions:",
        helpCenter: {
      ...
      student: {
        ...
        helpCenter: {
          ...
          description:
            "Review your profile information and make sure everything is correct.",
        },
        comunica: {
          title: "Say “Hello”",
          description:
  ...
  evaluation: {
    ...
    pending_evaluation_alert: {
      ...
      message:
        "When the teacher evaluates your activity, you will receive a notification",
    },
    not_submitted_alert: {
  ...
  activityNotStarted: {
    ...
    activityBlocked:
      "This activity is blocked by a previous activity in the module.",
