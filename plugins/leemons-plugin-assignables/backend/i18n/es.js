module.exports = {
  ...
  assignmentForm: {
    ...
    groups: {
      ...
      class: {
        ...
        notAllStudentsAssigned:
          "Algunos estudiantes no se incluirán en la actividad.",
    ...
    instructions: {
      ...
      editor: {
        placeholder:
          "Puedes especificar la mejor manera de consultar este contenido...",
      },
    },
    evaluation: {
      title: "Evaluación",
    ...
    others: {
      ...
      hideResponses:
        "Ocultar las respuestas de la actividad una vez finalizada.",
  ...
  activity_dashboard: {
    ...
    deleteModal: {
      ...
      message2:
        "Se eliminará toda la información relacionada con esta actividad.",
  ...
  activities_list: {
    ...
    nonEvaluable:
      "La actividad seleccionada no es evaluable y ya ha sido finalizada",
  },
  ongoing: {
  ...
  need_your_attention: {
    ...
    welcome: {
      ...
      teacher: {
        ...
        description2:
          "Mientras tanto y para empezar, te recomendamos las siguientes acciones:",
        helpCenter: {
      ...
      student: {
        ...
        helpCenter: {
          ...
          description:
            "Revisa la información de tu perfil y comprueba que todo está correcto.",
        },
        comunica: {
          title: "Decir “Hola”",
          description:
  ...
  activityNotStarted: {
    ...
    activityBlocked:
      "Esta actividad está bloqueada por una actividad anterior del módulo.",
