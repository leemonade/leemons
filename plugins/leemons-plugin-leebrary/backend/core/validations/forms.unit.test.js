...
describe("Form Validations", () => {
  describe("validateAddAsset", () => {
    ...
    it("should throw an error when required fields are missing", async () => {
      ...
      // Act and Assert
      await expect(validateAddAsset(data)).rejects.toThrow(
        LeemonsValidator.error
      );
    });
  });
  ...
  describe("validateSetPermissions", () => {
    ...
    it("should throw an error when required fields are missing", async () => {
      ...
      // Act and Assert
      await expect(validateSetPermissions(data)).rejects.toThrow(
        LeemonsValidator.error
      );
    });
  });
  ...
  describe("validateAddBookmark", () => {
    ...
    it("should throw an error when required fields are missing", async () => {
      ...
      // Act and Assert
      await expect(validateAddBookmark(data)).rejects.toThrow(
        LeemonsValidator.error
      );
    });
  });
