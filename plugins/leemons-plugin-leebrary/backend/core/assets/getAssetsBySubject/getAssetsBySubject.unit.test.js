...
it("Should filter a set of asset IDs by a given subject", async () => {
  // Arrange
  const assetSubjectOne = {
    id: "assetSubjectOne",
    asset: "assetOne",
    subject: "subjectOne",
  };
  const assetSubjectTwo = {
    id: "assetSubjectTwo",
    asset: "assetTwo",
    subject: "subjectOne",
  };
  const assetSubjectThree = {
    id: "assetSubjectThree",
    asset: "assetThree",
    subject: "subjectTwo",
  };
  const assetSubjectFour = {
    id: "assetSubjectFour",
    asset: "assetFour",
    subject: "subjectOne",
  };
  ...
  const responseSubjectTwo = await getAssetsBySubject({
    subject: "subjectTwo",
    assets,
    ctx,
  });
  ...
  expect(response).toEqual(
    expect.arrayContaining(["assetOne", "assetTwo", "assetFour"])
  );
