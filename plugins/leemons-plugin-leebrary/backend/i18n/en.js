  ...
  assetSetup: {
    ...
    basicData: {
      ...
      placeholders: {
        ...
        name: {
          'media-files': 'Resource Title',
          bookmarks: 'Bookmark Title',
          'assignables-content-creator': 'Document Title',
          'assignables-task': 'Task Title',
          'tests-questions-banks': 'Questions Bank Title',
          'assignables-tests': 'Test Title',
          'assignables-feedback': 'Feedback Title',
          'assignables-learningpaths-module': 'Module Title',
          'assignables-scorm': 'SCORM Title',
        },
        ...
        url: 'Webpage link',
        description: {
          'media-files': 'Resource description',
          bookmarks: 'Bookmark description',
          'assignables-content-creator': 'Document description',
          'assignables-task': 'Task description',
          'tests-questions-banks': 'Question Bank description',
          'assignables-tests': 'Test description',
          'assignables-feedback': 'Survey description',
          'assignables-learningpaths-module': 'Module description',
          'assignables-scorm': 'SCORM description',
        },
