module.exports = {
  ...
  assetSetup: {
    ...
    basicData: {
      ...
      errorMessages: {
        ...
        urlMetadata: {
          warning:
            "Unable to retrieve the URL data. You will have to enter it manually.",
        },
        file: {
  ...
  list: {
    ...
    labels: {
      ...
      emptyInstructions:
        "This asset does not have any instructions for teachers yet.",
    },
    cardToolbar: {
      edit: "Edit",
      duplicate: "Duplicate",
    ...
    emptyStates: {
      ...
      links: {
        ...
        "assignables.content-creator":
          "https://www.leemons.io/academy-post/content-creator",
        "assignables.task":
          "https://www.leemons.io/academy-post/tasks-assignments-1-create-and-assign",
        "assignables.tests":
          "https://www.leemons.io/academy-post/test-quizzes-1-create-and-assign",
        "tests-questions-banks":
          "https://www.leemons.io/academy-post/questions-banks",
  ...
  uploadFileModal: {
    ...
    fileOf:
      "Uploading file {currentFile} of {totalFiles} - {currentFilePercentageCompleted}%",
  ...
  bulkUpload: {
    ...
    bulkActionEditLabel: "Bulk edit",
    bulkActionShareLabel: "Share in bulk",
    assetsUpdatedSuccess: "Assets updated successfully",
    assetsUpdateError: "Error updating assets",
    backToLibraryLabel: "Back to library",
    tableEmptyState: {
      query: "No results for the query",
    },
    bulkEditDrawer: {
      title: "Bulk edit",
      presentation: "Presentation",
      alertEditPartOne: "Note that",
      alertEditPartTwo: "all selected resources will be edited in the table.",
      alertCoverPartOne: "The featured image will not be changed",
      alertCoverPartTwo: "to image resources.",
      colorLabel: "Color",
      colorPlaceholder: "Select a color",
      subjectsTitle: "Program and subjects",
      subjectsPlaceholder: "Select a subject",
