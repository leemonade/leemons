module.exports = {
  ...
  assetSetup: {
    ...
    basicData: {
      ...
      placeholders: {
        ...
        name: {
          "media-files": "Título del recurso",
          bookmarks: "Título del marcador",
          "assignables-content-creator": "Título del documento",
          "assignables-task": "Título de la tarea",
          "tests-questions-banks": "Título del banco de preguntas",
          "assignables-tests": "Título del test",
          "assignables-feedback": "Título de la encuesta",
          "assignables-learningpaths-module": "Título del modulo",
          "assignables-scorm": "Título del SCORM",
        },
        bookmarkName: "Título del marcador",
        tagline: "Subtítulo",
        tags: "Etiquetas",
        description: {
          "media-files": "Descripción del recurso",
          bookmarks: "Descripción del marcador",
          "assignables-content-creator": "Descripción del documento",
          "assignables-task": "Descripción de la tarea",
          "tests-questions-banks": "Descripción del banco de preguntas",
          "assignables-tests": "Descripción del test",
          "assignables-feedback": "Descripción de la encuesta",
          "assignables-learningpaths-module": "Descripción del modulo",
          "assignables-scorm": "Descripción del SCORM",
        },
  ...
  list: {
    ...
    labels: {
      ...
      searchListEmpty:
        "No hay ningún ítem disponible con tus criterios de búsqueda",
      ...
      emptyInstructions:
        "Este recurso no tiene instrucciones para los docentes todavía.",
    },
    cardToolbar: {
      edit: "Editar",
      duplicate: "Duplicar",
    ...
    emptyStates: {
      ...
      links: {
        ...
        "assignables.content-creator":
          "https://www.leemons.io/es/academy-post/crear-contenido",
        "assignables.task":
          "https://www.leemons.io/es/academy-post/crear-asignar-tareas-1",
        "assignables.tests":
          "https://www.leemons.io/es/academy-post/crear-asignar-tests-1",
        "tests-questions-banks":
          "https://www.leemons.io/es/academy-post/bancos-de-preguntas",
  ...
  uploadFileModal: {
    ...
    fileOf:
      "Subiendo archivo {currentFile} de {totalFiles} - {currentFilePercentageCompleted}%",
  ...
  bulkUpload: {
    ...
    bulkLoadLabel: "Carga en bloque",
    saveButton: "Guardar",
    requiredLabel: "Campo necesario",
    fileUploadTitle: "Click para buscar varios archivos",
    fileUploadSubtitle: "o arrastrar aquí desde el ordenador",
    fileUploadErrorTitle: "Error",
    fileUploadErrorMessage: "Archivo rechazado",
    table: {
      headers: {
        type: "Tipo",
        name: "Nombre",
    ...
    bulkActionEditLabel: "Editar en bloque",
    bulkActionShareLabel: "Compartir en bloque",
    assetsUpdatedSuccess: "Assets actualizados correctamente",
    assetsUpdateError: "Error al actualizar los assets",
    backToLibraryLabel: "Volver a biblioteca",
    tableEmptyState: {
      query: "No hay resultados para la consulta",
    },
    bulkEditDrawer: {
      title: "Edición en bloque",
      presentation: "Presentación",
      alertEditPartOne: "Ten en cuenta que",
      alertEditPartTwo:
        "se editarán todos los recursos seleccionados en la tabla.",
      alertCoverPartOne: "No se cambiará la imagen destacada",
      alertCoverPartTwo: "a los recursos de tipo imagen.",
      colorLabel: "Color",
      colorPlaceholder: "Selecciona un color",
      subjectsTitle: "Programa y asignaturas",
      subjectsPlaceholder: "Selecciona una asignatura",
      programLabel: "Programa",
      addSubjectLabel: "Añadir asignatura",
      courseLabel: "Curso",
      subjectsLabel: "Asignatura",
      tagsLabel: "Etiquetas",
      tagsPlaceholder: "Añadir etiqueta",
      addTagLabel: "Añadir etiqueta",
      saveButton: "Guardar",
      cancelButton: "Cancelar",
    },
    bulkShareDrawer: {
      alertPartOne: "Ten en cuenta que",
