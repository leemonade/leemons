...
import {
  ...
  LIBRARY_DETAIL_PROP_TYPES,
} from "./LibraryDetail.constants";
  ...
  return (
    ...
    >
      <Stack
        direction="column"
        fullHeight
        className={cx(classes.root, classes.wrapper, {
          [classes.show]: showDrawer,
        })}
        style={style}
      >
        <TotalLayoutContainer
              ...
              fileIcon={
                {
                  bookmark: (
                    <Box
                      style={{ fontSize: 64, lineHeight: 1, color: "#B9BEC4" }}
                    >
                      <AssetBookmarkIcon />
                    </Box>
                  ),
