module.exports = {
  listCurriculum: {
    ...
    page_description:
      "These are the curricula of the programmes this center delivers.",
  },
  addCurriculumBase: {
  ...
  addCurriculum: {
    ...
    description2:
      "Start by choosing the program to create the structure of the curriculum",
    nameLabel: "Name",
  ...
  addCurriculumStep3: {
    ...
    starDescription:
      "The blocks marked with a star correspond to evaluation criteria.",
    newBranchValue: {
      nameLabel: "Name",
