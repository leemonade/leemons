module.exports = {
        ...
        labels: {
          ...
          submission: {
            ...
            FileType: {
              ...
              formatPlaceholder:
                "Escribir extensión y añadir (pdf, xls, doc...)",
  ...
  assignment_form: {
    ...
    descriptions: {
      ...
      closeDateToogle:
        "NOTA: Después de esta fecha, la tarea no podrá ser evaluada.",
      limitedExecution:
  ...
  profiles_page: {
    ...
    student: "Estudiante",
    studentDescription:
      "Se le asignarán las tareas y será responsable de ejecutarlas",
  ...
  task_realization: {
    ...
    introduction_step: {
      ...
      not_opened: {
        ...
        description:
          "Esta actividad estará disponible el día {date} a las {time}.",
      },
    },
    development_step: {
    ...
    timeout_modal: {
      title:
        "El tiempo establecido para completar esta actividad ha finalizado.",
      description:
    ...
    limitedTimeAlert: {
      ...
      closedTaskSecondLine:
        "La fecha de inicio para poder realizar esta actividad es: {{time}}",
    },
  },
  task_correction: {
    action: "feedback",
    ...
    teacher: {
      ...
      add_feedback:
        "Dar feedback cualitativo al estudiante sobre su desempeño en esta actividad",
