module.exports = {
  ...
  welcome_page: {
    ...
    step_history: {
      title: "History",
      description:
        "View completed tasks, their evaluations, and the student's feedback.",
  ...
  task_setup_page: {
    ...
    setup: {
      ...
      contentData: {
        ...
        labels: {
          ...
          submission: {
            ...
            gradable: "Gradable",
            checkDescription:
              "This task requires the submission of a file, document or link.",
      ...
      instructionData: {
        ...
        placeholders: {
          forTeacher:
            "Help other teachers approach this exercise with a few simple instructions.",
          forStudent:
  ...
  assignment_form: {
    labels: {
      ...
      alwaysOpenToogle:
        "This task is always available and can be performed at any time.",
  ...
  profiles_page: {
    ...
    student: "Student",
    studentDescription:
      "Will be assigned the tasks and will be responsible for executing them",
  ...
  task_correction: {
    ...
    teacher: {
      ...
      add_feedback:
        "Add feedback to the student about his performance in this activity",
    ...
    saveAndSendMessage:
      "The changes have been saved and have been sent to the student",
